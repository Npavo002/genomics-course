...
```
###Tutorial figures
!["Basic Data"](Images/galFiltered network with data(1).png)
!["Geneup"](Images/String Network(Geneup).png)
!["Genedown"](Images/String Network - 1(gene_down).png)
!["Basic Data"](Images/String Network - ovarian cancer(1).png)
